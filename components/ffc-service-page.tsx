              ...
              <Link key={pkg.id} href={`/packages/${pkg.slug}`}>
                <Card className="h-full hover:shadow-lg transition-all hover:-translate-y-1 border-rose-100 group">
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-semibold mb-1 group-hover:text-rose-600 transition-colors line-clamp-1">
                      {pkg.name}
                    </h3>
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
            {vadodaraAreas.slice(0, 15).map((area) => (
              <Link 
                key={area.slug}
                href={`/${area.slug}`}
                className="px-4 py-2 bg-white rounded-full text-gray-700 hover:bg-rose-600 hover:text-white transition-colors border border-rose-200 text-sm"
              >
            ...
            <Link 
              href="/areas"
              className="px-4 py-2 bg-rose-600 rounded-full text-white hover:bg-rose-700 transition-colors text-sm"
            >
              View All Areas
            </Link>
          </div>
