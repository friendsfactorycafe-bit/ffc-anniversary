      ...
      <div className="bg-rose-50 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link href="/packages" className="text-gray-500 hover:text-rose-600">Packages</Link>
            <ChevronRight className="h-4 w-4 text-gray-400" />
            <span className="text-rose-600 font-medium">{pkg.name}</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12">
            ...
            <div className="mt-4 lg:mt-0">
              {/* Title & Tagline */}
              <Badge className="mb-3 md:mb-4 bg-rose-100 text-rose-700 border-rose-200">
              ...
              <div className="bg-rose-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6">
                <p className="text-rose-800 italic text-sm md:text-base">
              ...
              {/* Price */}
              <div className="mb-4 md:mb-6">
                <span className="text-2xl md:text-3xl font-bold text-rose-600">{formatPrice(pkg.price)}</span>
              </div>
              ...
              {pkg.features.map((feature, index) => (
                <div key={index} className="flex items-start gap-3 bg-white rounded-lg p-3 md:p-4">
                  <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-rose-100 flex items-center justify-center flex-shrink-0">
                    <Check className="h-4 w-4 md:h-5 md:w-5 text-rose-600" />
                  </div>
                  <div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className={`rounded-xl p-4 md:p-6 text-center ${pkg.cakeIncluded ? 'bg-gradient-to-br from-green-100 to-emerald-100 border-2 border-green-200' : 'bg-gradient-to-br from-rose-100 to-pink-100'}`}>
                <h4 className={`font-bold text-lg md:text-xl mb-2 ${pkg.cakeIncluded ? 'text-green-800' : 'text-rose-800'}`}>🎂 Cake & Champagne</h4>
                {pkg.cakeIncluded ? (
                  <>
                  ...
                  <>
                    <p className="text-rose-700 text-sm md:text-base"><strong>Cake:</strong> ₹500/- (Extra Cost)</p>
                    <p className="text-gray-700 text-sm md:text-base mt-1"><strong>Champagne:</strong> ₹500/- (Non-Alcoholic Fruit Flavour)</p>
                  </>
                )}
              </div>
              <div className="bg-gradient-to-br from-rose-100 to-pink-100 rounded-xl p-4 md:p-6 text-center">
                <h4 className="font-bold text-lg md:text-xl text-rose-800 mb-2">⏰ 3 Mesmerizing Hours</h4>
