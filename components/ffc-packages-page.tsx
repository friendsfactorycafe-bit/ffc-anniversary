              ...
              <Link key={pkg.id} href={`/packages/${pkg.slug}`}>
                <Card className="overflow-hidden border-rose-100 hover:shadow-xl transition-all group h-full">
                  ...
                  <div className="aspect-square bg-gradient-to-br from-rose-100 to-pink-100 relative overflow-hidden">
                    ...
                    />
                    <Badge className="absolute top-2 left-2 md:top-4 md:left-4 bg-rose-600 text-white text-xs">
                      Setup {index + 1}
                    </Badge>
                  </div>
                  ...
                  <CardContent className="p-3 md:p-4">
                    <h2 className="text-sm md:text-base lg:text-lg font-bold mb-1 group-hover:text-rose-600 transition-colors line-clamp-2">
                      {pkg.name} {pkg.emoji}
                    </h2>
