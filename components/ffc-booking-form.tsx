                    ...
                    {packages.map((pkg) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="shrink-0 inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[9px] sm:text-[10px] font-medium rounded-full bg-rose-100 text-rose-700 hover:bg-rose-600 hover:text-white transition-colors"
                        >
