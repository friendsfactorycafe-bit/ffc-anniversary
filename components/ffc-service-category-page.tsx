...
export default function FFCServiceCategoryPage({ service }: ServiceCategoryPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-rose-50 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <Link href="/services" className="text-gray-500 hover:text-rose-600">Services</Link>
            <ChevronRight className="h-4 w-4 text-gray-400" />
            <span className="text-rose-600 font-medium">{service.name}</span>
          </nav>
        </div>
      </div>

      {/* Hero Section */}
      <section className="bg-gradient-to-br from-rose-600 via-pink-500 to-rose-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
      ...
      <section className="py-16 bg-gradient-to-br from-rose-50 to-pink-50">
        <div className="container mx-auto px-4">
              ...
              <Link key={pkg.id} href={`/packages/${pkg.slug}`}>
                <Card className="h-full hover:shadow-xl transition-all hover:-translate-y-2 border-rose-100 overflow-hidden group">
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-bold text-gray-800 mb-2 group-hover:text-rose-600 transition-colors line-clamp-2">
                      {pkg.name}
                    </h3>
                    <p className="text-sm text-gray-600 mb-3 line-clamp-2">{pkg.shortDescription}</p>
                    <div className="flex items-center justify-between">
                      <span className="text-rose-600 font-bold">{formatPrice(pkg.price)}</span>
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded bg-rose-600 text-white group-hover:bg-rose-700 transition-colors">View <ChevronRight className="h-3 w-3" /></span>
                    </div>
                  </CardContent>
                </Card>
              </Link>
          ...
          <div className="text-center mt-8">
            <Link href="/packages">
              <Button size="lg" className="bg-gradient-to-r from-rose-600 to-pink-500 hover:from-rose-700 hover:to-pink-600 text-white">
                View All 8 Packages
              </Button>
            </Link>
          </div>
      ...
      <section className="py-16 bg-rose-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="text-rose-600 text-sm">{content.testimonial.occasion}</div>
          </div>
        </div>
      </section>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {content.faqs.map((faq, index) => (
                <AccordionItem key={index} value={`faq-${index}`} className="border rounded-lg px-4">
                  <AccordionTrigger className="text-left font-medium text-gray-800 hover:text-rose-600">
                    {faq.question}
                  </AccordionTrigger>
      ...
      {/* Booking Form */}
      <section className="py-16 bg-gradient-to-br from-rose-600 to-pink-500">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
