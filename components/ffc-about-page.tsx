            ...
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-rose-100 flex items-center justify-center mx-auto mb-3">
                  <stat.icon className="h-7 w-7 md:h-8 md:w-8 text-rose-600" />
                </div>
                <p className="text-2xl md:text-3xl font-bold text-rose-600">{stat.number}</p>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`tel:${siteConfig.phone}`}>
              <Button size="lg" className="bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white w-full sm:w-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="border-rose-200">
                <CardContent className="p-6 text-center">
                  ...
                  <a href={`tel:${siteConfig.phone}`} className="text-rose-600 hover:text-rose-700 font-medium">
                    {siteConfig.phone}
                  </a>
                </CardContent>
              </Card>
              ...
              <Card className="border-rose-200">
                <CardContent className="p-6 text-center">
                  ...
                  <a href={`mailto:${siteConfig.email}`} className="text-rose-600 hover:text-rose-700">
                    {siteConfig.email}
                  </a>
                </CardContent>
              </Card>
